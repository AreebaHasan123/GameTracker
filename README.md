...
There is also a folder called DataAccess. This basically contains the different classes and interfaces I used to set up the connection so that these CSV files can be created. IDataConnection is an interface that GlobalConfig ends up using. This is a composition relationship as GlobalConfig has list of IDataConnections. If I were to expand this process, I would work on implementing some sort of database like SQL rather than a flat file. 
